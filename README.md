...
<head>
    ...
    <script src='//libtl.com/sdk.js' data-zone='10663694' data-sdk='show_10663694'></script>
    ...
    <div class="container">
        ...
        <div class="page-section active" id="home-page">
            ...
            <div class="rate-info">
                ...
                <p><i class="fas fa-gift"></i> রেফারেল বোনাস: ৫ টাকা প্রতি ব্যবহারকারী</p><!DOCTYPE html>
<html lang="bn">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    ...
    <script>
        ...
        const BOT_TOKEN = "8565372776:AAEO9asKgn-FNFTSSPMgrB9W0BawpFJF3oE আপনার বট টোকেন
        const ADMIN_CHAT_ID = "6344416101"; // আপনার টেলিগ্রাম চ্যাট আইডি
        ...
        function checkAdReady() {
            if (typeof window.show_10663694 !== 'function') {
